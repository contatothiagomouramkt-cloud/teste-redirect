export default {                                                                                                                
    async fetch(request) {                                                                                                        
      ...
      // Redirect WhatsApp (seu código original)                                                                                                                                                            
      const numeros = [                   
        "5575936181361", // T37                                                                                                                                                                             
        "5575936181364", // T54                                                                                                                                                                             
        "5575936181023", // D42
      ...
      const mensagens = [                                                                                                                                                                                   
        ...
        "E aí JP, manda a boa pra mim, quero iniciar!",                                                                                                                                                     
        "Jotap, quero iniciar hoje, me manda a boa!",                                                                                                                                                     
        "Fala irmão, me manda aquela boa pra iniciar hoje!",
        "JP, manda a oportunidade de hoje, quero iniciar!",                                                                                                                                                 
        "E aí Jota, quero iniciar hoje, manda pra mim!"
      ];                                                                                                                                                                                                    
